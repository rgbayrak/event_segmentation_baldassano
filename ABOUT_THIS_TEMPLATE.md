...
├── event_segmentation_baldassano             # The main python package for the project
...
e.g: `cat event_segmentation_baldassano/VERSION` will get the project version without harming
